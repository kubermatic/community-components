...
case "${DEPLOY_STACK}" in
  monitoring)
    ...
    injectCustomCA "blackbox-exporter" "monitoring" ./monitoring/blackbox-exporter/
...
#      deploy "certs" "default" ./certs/
      ...
      injectCustomCA "oauth" "oauth" ./oauth/
    ...
    # Kubermatic
    injectCustomCA "kubermatic" "kubermatic" ./kubermatic/
