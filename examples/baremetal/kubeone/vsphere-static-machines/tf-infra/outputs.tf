...
output "kubeone_cp_hosts" {
  ...
  value = {
    control_plane = {
      ...
      private_address = []
      hostnames = vsphere_virtual_machine.control_plane[*].vapp[0].properties.hostname
...
//          templateVMName = var.worker_template
//          vmNetName = var.network_name
//          resourcePool = var.resource_pool_name
//          folder = "/${var.dc_name}/vm/${var.folder_name}"
//        }
//      }
//    }
//  }
